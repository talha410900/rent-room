...
const apiUrl = "https://admin-rentroom.rentcubo.info/api/provider/"; // Production Mode

// const apiUrl = "http://localhost:8000/api/provider/"; // Development Mode
...
const HostEnvironment = {
    ...
    newMethod(action, object) {
        ...
        const url =
            "https://admin-rentroom.rentcubo.info/default-json/settings.json";
