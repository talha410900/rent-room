                                        ...
                                        <div className="panel-body p-3">
                                            <ul className="verified-list">
                                                <li>
                                                    ...
                                                    <span>
                                                        {data.is_verified ? (
                                                            <i class="far fa-check-circle theme-green-clr float-right align-3" />
                                                        ) : (
                                                            <i class="far fa-times-circle text-warning float-right align-3" />
                                                        )}
                                                    </span>
                                                </li>
                                                <li>
                                                    ...
                                                    <span>
                                                        {data.mobile ? (
                                                            <i class="far fa-check-circle theme-green-clr float-right" />
                                                        ) : (
                                                            <i class="far fa-times-circle text-warning float-right" />
                                                        )}
                                                    </span>
                                                </li>
                                            </ul>
