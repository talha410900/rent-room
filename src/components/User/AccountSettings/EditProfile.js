                      ...
                      <div className="form-group row">
                        ...
                        <div className="col-9">
                          <textarea
                            ...
                            rows="4"
                            name="description"
                            value={loading ? "Loading" : data.description}
                            onChange={this.handleChange}
                          />
                          ...
                          <h5 className="profile-note">
                            Tell them about the things you like: What are 5
                            things you can’t live without? Share your favorite
                            travel destinations, books, movies, shows, music,
                            food
                          </h5>
