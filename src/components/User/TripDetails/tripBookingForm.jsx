...
class TripBookingForm extends Helper {
    ...
    increament = value => {
        ...
        if (value === "adults") {
            let adultsCount =
                this.state.adults >= this.props.basicDetails.min_guests
                    ? this.state.adults + 1
                    : this.props.basicDetails.min_guests;
            this.setState({
                adults: adultsCount
            });
        }
        if (value === "children") {
            let childrenCount =
                this.state.children >= 0 ? this.state.children + 1 : 0;
            this.setState({
        ...
        if (value === "infants") {
            let infantsCount =
                this.state.infants >= 0 ? this.state.infants + 1 : 0;
