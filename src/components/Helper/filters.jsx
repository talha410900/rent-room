        ...
        <div className="section-spacing sub-nav">
          <ul className="filters">
                ...
                <form className="inc-dec-count">
                  ...
                  <div className="row guest-options">
                    <div className="col-6 col-sm-6">
                      ...
                      <small className="text-muted"><br />Ages 2–12</small></label>
                    </div>
                    <div className="col-6 col-sm-6 text-right">
                      <div className="float-right">
                        <div
                  ...
                  <div className="row guest-options">
                    <div className="col-6 col-sm-6">
                      <label htmlFor="name">infants
                      <small className="text-muted"><br />Under 2</small></label>
            ...
            {this.state.total_home_type != 0
              ? 
                <button className="dropdown-toggle filter-active" data-toggle="dropdown"> Home Type - {this.state.total_home_type}</button>
              : 
                <button className="dropdown-toggle" data-toggle="dropdown">Type Of Place</button>
                }
